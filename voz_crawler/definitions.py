...
from voz_crawler.defs.resources.graph_store_resource import Neo4jGraphStoreResource
...
defs = Definitions(
    ...
    resources={
        ...
        "graph_store": Neo4jGraphStoreResource(
            uri=EnvVar("NEO4J_URI"),
            username=EnvVar("NEO4J_USER"),
            password=EnvVar("NEO4J_PASSWORD"),
            database=EnvVar("NEO4J_DATABASE"),
        ),
    },
)
